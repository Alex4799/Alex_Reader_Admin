...
@section('contect')
    <div class="container py-5">
        <h1 class="text-center mb-5">Edit Category</h1>
            <form action="{{route('admin#categoryUpdate',$data->id)}}" method="post">
                @csrf
                <div class="row">
                    <div class="col-lg-6 offset-lg-3 shadow p-5">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                            <input name="name" value="{{$data->name}}" type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Name">
                            @error('name')
