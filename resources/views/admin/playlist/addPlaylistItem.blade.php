            ...
            <div class="row">
                ...
                <div class="col-lg-8 offset-lg-2 shadow my-2 p-5">
                    ...
                    @endif
                        ...
                        <div class="@if ($post->image!=null) col-9 @endif">

                            <div class="row">
                                <h4 class="col-6"><a href="{{route('admin#viewPost',$post->id)}}">{{$post->Title}}</a></h4>
                                <a title="Add" href="{{route('admin#addPlaylistItem',[$post->id,$playList->id])}}" class="btn btn-light col-1 offset-4"><i class="fa-solid fa-plus"></i></a>
                            </div>
