...
@section('contect')
    <div class="container py-5">
        ...
        <div>
            <a href="{{route('admin#playlistAddpage')}}" class="btn btn-secondary float-lg-end"><i class="fa-solid fa-plus"></i>Add Playlist</a>
        </div>
        ...
        <table class="table table-striped rounded">
            ...
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    <td class="py-5">
                        <a href="{{route('admin#playlistItem',$item->id)}}" class="btn btn-light rounded-circle me-2" title="View"><i class="fa-solid fa-eye"></i></a>
                        <a href="{{route('admin#playlistEdit',$item->id)}}" class="btn btn-light rounded-circle me-2" title="Edit"><i class="fa-solid fa-pen-to-square"></i></a>
                        <a href="{{route('admin#playlistDelete',$item->id)}}" class="btn btn-light rounded-circle me-2" title="Delete"><i class="fa-solid fa-trash"></i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
